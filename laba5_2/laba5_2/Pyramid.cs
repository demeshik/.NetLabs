...
namespace laba_1
{
    public class Pyramid : laba_1.IPyramid, IComparable
    {
        ...
        public override string ToString() => $"Id - {Id}, Apofem - {_Height}, Perimetr - {_Perimetr}, SquareBottom - {_Square}";
        ...
        public int CompareTo(object obj)
        {
            ...
            if (temp != null)
                ...
                throw new SystemException("Объект не является пирамидой");
        }
    }
}
